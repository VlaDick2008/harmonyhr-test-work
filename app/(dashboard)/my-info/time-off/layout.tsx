...
export default function MyInfoLayout({
	...
	return (
		<section className="relative h-full">
			<div className="w-full bg-slate-300 xl:pl-[25%] pl-0 xl:pr-24 pt-20">
				<MyInfoHeader />
				<div className="overflow-x-auto">
					<nav className="mt-6 pt-4 [&>*]:h-full [&>*]:flex-1 text-center [&>*]:p-4 [&>*]:rounded-t-md flex justify-between xl:w-full w-[1100px]">
			...
			<div className="w-full bg-slate-100 xl:pl-[25%] pb-20">{children}</div>
